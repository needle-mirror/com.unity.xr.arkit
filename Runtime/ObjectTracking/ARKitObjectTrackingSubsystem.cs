...
namespace UnityEngine.XR.ARKit
{
    ...
    /// </summary>
    [Preserve]
    public sealed class ARKitObjectTrackingSubsystem : XRObjectTrackingSubsystem
    {
        ...
        static void RegisterDescriptor()
        {
            ...
            {
                id = "ARKit-ObjectTracking",
                providerType = typeof(ARKitProvider),
                subsystemTypeOverride = typeof(ARKitObjectTrackingSubsystem)
            });
        }
    }
}
