...
namespace UnityEngine.XR.ARKit
{
    ...
    /// </summary>
    [Preserve]
    public sealed class ARKitPointCloudSubsystem : XRPointCloudSubsystem
    {
        ...
        static void RegisterDescriptor()
        {
            ...
            {
                id = "ARKit-PointCloud",
                providerType = typeof(ARKitPointCloudSubsystem.ARKitProvider),
                subsystemTypeOverride = typeof(ARKitPointCloudSubsystem),
